...
First option is 100 dollars per day for 10 days.
Second option is 1 dollar a day with it being doubled each day for 10 days. 
There will be two functions to calculate the pay rate. 

Function-1 will calculate the amount for the first option. 
Function-2 will calculate the amount for the second option. 
...
If the amount is equal, we ouput to the user "Option 1 and Option 2 pays the same". 
